...
export default function ContactSection() {
  ...
  return (
    <section id="contact_me" className="w-full py-12 md:py-24 lg:py-32 bg-gray-50 dark:bg-gray-900">
      <div className="container px-4 md:px-6 mx-auto">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Lets Get in Touch?</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-2">
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400">adityazaveri7@gmail.com</p>
              </div>
              <div>
