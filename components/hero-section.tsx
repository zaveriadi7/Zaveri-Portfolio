...
export default function HeroSection() {
  return (
    <>
      <section id="hero" className="w-full 2xl:max-w-5xl py-12 md:py-24 lg:py-36 xl:pt-[200px] bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900">
