...
/>                </span>
          ...
          <div className="relative w-[400px] aspect-square rounded-full border-8 border-white shadow-xl dark:border-gray-800">
            {/* Central emoji */}
  ...
  {[
    ...
    return (
      <div
        ...
        style={{
          transform: `rotate(${angle}deg) translateX(190px)`, // ✅ Removed rotate(-angle)
          zIndex: 50,
        }}
      >
        <div
